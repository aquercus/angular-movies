...
@Component({
  selector: 'app-my-third-form',
  templateUrl: './my-third-form.component.html',
  styleUrls: ['./my-third-form.component.css']
})
export class MyThirdFormComponent implements OnInit {
  imdbId : string;
  title : string;
  year : number;
  rating : number;
